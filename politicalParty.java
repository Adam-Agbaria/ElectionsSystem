...
public class politicalParty implements Serializable {
	...
	public politicalParty(String nameOfParty, int year, int month, Faction faction, Candidate[] candidates) {
	...
	public boolean equals(Object obj) {
		...
		if (this.getClass().equals(obj.getClass())) {
			...
			if (tmp.nameOfParty == this.nameOfParty && tmp.month == this.month && tmp.year == this.year
